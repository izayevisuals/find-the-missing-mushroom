...
function hideTreeSix() {
    document.getElementById('treeSix').style.display = 'none'
}


function hideTreeSeven() {
    document.getElementById('treeSeven').style.display = 'none'
}

function hideTreeEight() {
    document.getElementById('treeEight').style.display = 'none'
}

function hideTreeNine() {
    document.getElementById('treeNine').style.display = 'none'
}

function hideTreeTen() {
    document.getElementById('treeTen').style.display = 'none'
}

function hideTreeEleven() {
    document.getElementById('treeEleven').style.display = 'none'
}

function hideTreeTwelve() {
    document.getElementById('treeTwelve').style.display = 'none'
}

function hideTreeThirteen() {
    document.getElementById('treeThirteen').style.display = 'none'
}

function hideTreeFourteen() {
    document.getElementById('treeFourteen').style.display = 'none'
}
